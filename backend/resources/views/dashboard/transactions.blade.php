<x-dashboard.page title="Transactions">
    <div class="row">
        <div class="col-12">
                ...
                <div class="card-body px-0 py-0">
                    <div class="border-bottom py-3 px-3 d-sm-flex align-items-center">
                        <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                            ...
                            <label class="btn btn-white px-3 mb-0" for="btnradiotable2">This Month</label>
                            <input type="radio" class="btn-check" name="btnradiotable" id="btnradiotable3" autocomplete="off" />
                            <label class="btn btn-white px-3 mb-0" for="btnradiotable3">This Year</label>
                        </div>
                            ...
                            <div class="card-body d-flex flex-column justify-content-center text-center">
                                <a href="{{ route('dashboard.payments') }}">
                                    <div class="icon icon-shape bg-dark text-center text-white rounded-circle mx-auto d-flex align-items-center justify-content-center mb-2">
                                        <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="currentColor"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 19h-6a3 3 0 0 1 -3 -3v-8a3 3 0 0 1 3 -3h12a3 3 0 0 1 3 3v4.5" /><path d="M3 10h18" /><path d="M16 19h6" /><path d="M19 16l3 3l-3 3" /><path d="M7.005 15h.005" /><path d="M11 15h2" /></svg>
                                    </div>
                                    <h5 class="text-dark text-lg">Make a payment</h5>
                                    <p class="text-sm text-secondary mb-0">There's no transaction to display. Click the icon to make a new payment 🙃</p>
                                </a>
                            </div>
                        </div>
                    @endif
