<nav class="navbar navbar-main navbar-expand-lg mx-2 px-0 shadow-none rounded" id="navbarBlur" navbar-scroll="true">
    <div class="container-fluid py-1 px-2 flex-sm-nowrap">
        <nav aria-label="breadcrumb">
            <h6 class="font-weight-bold mb-0">{{ config('dashboard.navTitle') }}</h6>
        </nav>
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4 justify-content-end" id="navbar">
            <div class="pe-md-3 d-md-flex d-none align-items-center">
            ...
            <ul class="navbar-nav  justify-content-end">
                ...
                <li class="nav-item ps-2 d-flex align-items-center">
                    <a href="javascript:;" class="nav-link text-body p-0">
                        <img src="{{ asset('cUI/img/team-2.jpg') }}" class="avatar avatar-sm" alt="avatar" />
                    </a>
                </li>
            </ul>
        </div>
