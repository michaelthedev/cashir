        ...
        <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
                <div class="copyright text-center text-xs text-muted text-lg-start">
                    ...
                    Made by <a href="https://github.com/michaelthedev" target="_blank">@michaelthedev</a>, template by
            ...
            <div class="col-lg-6">
                <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                    <li class="nav-item">
                        <a href="https://github.com/michaelthedev" class="nav-link text-xs text-muted" target="_blank">My GitHub</a>
                    </li>
                    <li class="nav-item">
