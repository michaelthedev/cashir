                        ...
                        <table class="table align-items-center justify-content-center mb-0">
                                ...
                                <td>
                                    <div class="d-flex px-2">
                                        <div class="avatar avatar-sm rounded-circle bg-gray-100 me-2 my-2">
                                            <img src="{{ asset('cUI/img/small-logos/logo-spotify.svg') }}"
                                ...
                                <td class="align-middle">
                                    <div class="d-flex">
                                        <div
                                            ...
                                            <img src="{{ asset('cUI/img/logos/visa.png') }}" class="w-90 mx-auto"
                                                 alt="visa">
                                        </div>
                                        <div class="ms-2">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex px-2">
                                        <div class="avatar avatar-sm rounded-circle bg-gray-100 me-2 my-2">
                                            <img src="{{ asset('cUI/img/small-logos/logo-invision.svg') }}"
                                ...
                                <td class="align-middle">
                                    <div class="d-flex">
                                        <div
                                            class="border px-1 py-1 text-center d-flex align-items-center border-radius-sm my-auto">
                                            <img src="{{ asset('cUI/img/logos/mastercard.png') }}"
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex px-2">
                                        <div class="avatar avatar-sm rounded-circle bg-gray-100 me-2 my-2">
                                            <img src="{{ asset('cUI/img/small-logos/logo-jira.svg') }}"
                                                 class="w-80" alt="jira">
                                        </div>
                                        <div class="my-auto">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex px-2">
                                        <div class="avatar avatar-sm rounded-circle bg-gray-100 me-2 my-2">
                                            <img src="{{ asset('cUI/img/small-logos/logo-slack.svg') }}"
