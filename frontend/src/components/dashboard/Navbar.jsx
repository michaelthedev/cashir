...
export default function Navbar() {
  return (
    <>
      <nav className="navbar navbar-main navbar-expand-lg mx-2 px-0 shadow-none rounded" id="navbarBlur"
           navbar-scroll="true">
              ...
              <li className="nav-item px-3 d-flex align-items-center">
                <a href="javascript:" className="nav-link text-body p-0">
                  <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg"
                       className="fixed-plugin-button-nav cursor-pointer" viewBox="0 0 24 24" fill="currentColor">
              ...
              <li className="nav-item dropdown pe-2 d-flex align-items-center">
                <a href="javascript:" className="nav-link text-body p-0" id="dropdownMenuButton"
                  ...
                  <svg height="16" width="16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                       fill="currentColor" className="cursor-pointers">
                    <path fillRule="evenodd"
                ...
                <ul className="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4"
                    ...
                    <a className="dropdown-item border-radius-md" href="javascript:">
                      <div className="d-flex py-1">
                        <div className="my-auto">
                          <img src="{{ asset('cUI/img/team-2.jpg') }}"
                               className="avatar avatar-sm border-radius-sm  me-3 "/>
                        </div>
                  ...
                  <li className="mb-2">
                    <a className="dropdown-item border-radius-md" href="javascript:">
                      <div className="d-flex py-1">
                        <div className="my-auto">
                          <img src="{{ asset('cUI/img/small-logos/logo-google.svg') }}"
                               className="avatar avatar-sm border-radius-sm bg-gradient-dark p-2  me-3 "/>
                        </div>
                        <div className="d-flex flex-column justify-content-center">
                          <h6 className="text-sm font-weight-normal mb-1">
