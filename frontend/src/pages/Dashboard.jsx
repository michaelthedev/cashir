              ...
              <div className="card-body text-start p-3 w-100">
                ...
                <div className="row">
                  ...
                  <span className="text-sm text-success font-weight-bolder">
                    <i className="fa fa-chevron-up text-xs me-1" />
                    10.5%
                  </span>
            ...
            <div className="card shadow-xs border h-100">
              ...
              <div className="card-body py-3">
                <div className="chart mb-2">
                  <canvas id="chart-bars" className="chart-canvas" height={240} />
                </div>
                      ...
                      <td>
                        <div className="d-flex px-2">
                          <div className="avatar avatar-sm rounded-circle bg-gray-100 me-2 my-2">
                            <img
                              src="{{ asset('cUI/img/small-logos/logo-spotify.svg') }}"
                              className="w-80"
                              alt="spotify"
                            />
                          </div>
                      ...
                      <td className="align-middle">
                        <div className="d-flex">
                          <div className="border px-1 py-1 text-center d-flex align-items-center border-radius-sm my-auto">
                            <img
                              src="{{ asset('cUI/img/logos/visa.png') }}"
                    ...
                    <tr>
                      <td>
                        <div className="d-flex px-2">
                          <div className="avatar avatar-sm rounded-circle bg-gray-100 me-2 my-2">
                            <img
                              src="{{ asset('cUI/img/small-logos/logo-invision.svg') }}"
                              className="w-80"
                              alt="invision"
                            />
                          </div>
                    ...
                    <span className="text-sm font-weight-normal">
                      ...
                      <td className="align-middle">
                        <div className="d-flex">
                          <div className="border px-1 py-1 text-center d-flex align-items-center border-radius-sm my-auto">
                            <img
                              src="{{ asset('cUI/img/logos/mastercard.png') }}"
                              className="w-90 mx-auto"
                              alt="mastercard"
                            />
                          </div>
                    ...
                    <tr>
                      <td>
                        <div className="d-flex px-2">
                          <div className="avatar avatar-sm rounded-circle bg-gray-100 me-2 my-2">
                            <img
                              src="{{ asset('cUI/img/small-logos/logo-jira.svg') }}"
                              className="w-80"
                              alt="jira"
                            />
                          </div>
                    ...
                    <tr>
                      <td>
                        <div className="d-flex px-2">
                          <div className="avatar avatar-sm rounded-circle bg-gray-100 me-2 my-2">
                            <img
                              src="{{ asset('cUI/img/small-logos/logo-slack.svg') }}"
                              className="w-80"
                              alt="slack"
                            />
                          </div>
